...
```console
Layout '†@uok~vg
⇙z†⇙aie xfstnc⇙†?/⇙j    bdmpwqy⇙rh⇙l††{A$†QGN#††<I,:_KV"LRMX†`;Z[\WB|&^†'⇙S]⇙}††UOY†DT=+††%!(*HJC).-PF†6598731402†⇙⇙⇙>⇙E' (layer 0):
            ┌───┐                         ┌───┐
        ┌───┤ o ├───┬───┐         ┌───┬───┤ ⏎ ├───┐
┌───┬───┤ u ├───┤ k │ ~ │         │ v │ g ├───┤sft├───┬───┐
│ □ │ @ ├───┤ e ├───┼───┤         ├───┼───┤ t ├───┤ z │ □ │
...
Layout '†@uok~vg
⇙z†⇙aie xfstnc⇙†?/⇙j    bdmpwqy⇙rh⇙l††{A$†QGN#††<I,:_KV"LRMX†`;Z[\WB|&^†'⇙S]⇙}††UOY†DT=+††%!(*HJC).-PF†6598731402†⇙⇙⇙>⇙E' (layer 1):
            ┌───┐                         ┌───┐
        ┌───┤ A ├───┬───┐         ┌───┬───┤ N ├───┐
┌───┬───┤ { ├───┤ $ │ □ │         │ Q │ G ├───┤ # ├───┬───┐
│ □ │d` ├───┤ : ├───┼───┤         ├───┼───┤ L ├───┤d^ │ □ │
...
Layout '†@uok~vg
⇙z†⇙aie xfstnc⇙†?/⇙j    bdmpwqy⇙rh⇙l††{A$†QGN#††<I,:_KV"LRMX†`;Z[\WB|&^†'⇙S]⇙}††UOY†DT=+††%!(*HJC).-PF†6598731402†⇙⇙⇙>⇙E' (layer 2):
            ┌───┐                         ┌───┐
        ┌───┤ O ├───┬───┐         ┌───┬───┤ = ├───┐
┌───┬───┤ U ├───┤ Y │ □ │         │ D │ T ├───┤ + ├───┬───┐
│ □ │ é ├───┤ * ├───┼───┤         ├───┼───┤ . ├───┤ ç │ □ │
...
Layout as text:
†@uok~vg
⇙z†⇙aie xfstnc⇙†?/⇙j    bdmpwqy⇙rh⇙l

+ Layer 3 with arrows, pg up/down ect on right hand,
  sound, luminosity etc on left,
  and fn keys somewhere
```
