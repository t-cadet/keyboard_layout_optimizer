...
#[derive(Clone, Debug)]
pub struct OxeyBadRedirects {
    exclude_thumbs: bool,
    exclude_modifiers: bool,
    exclude_chars: AHashSet<char>,
}

impl OxeyBadRedirects {
...
impl TrigramMetric for OxeyBadRedirects {
    fn name(&self) -> &str {
        "Bad Redirects"
    }
    ...
    fn individual_cost(
        ...
        // if at least one key is be hit with the index finger it is not a bad redirect
